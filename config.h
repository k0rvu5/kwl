...
/*static const char *menucmd[] = { "wmenu-run", "-f", "JetBrainsMono Nerd Font 9", NULL };*/
static const char *menucmd[] = { "wmenu-run", "-f", "JetBrainsMono Nerd Font Bold 9", "-N", "1e1e2e", "-n", "cdd6f4", "-m", "cdd6f4", "-s", "1e1e2e", "-S", "f5c2e7", NULL };
